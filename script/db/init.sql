...
INSERT INTO `oauth_client_details` VALUES (1,'cloudrs',NULL,'{bcrypt}$2a$10$zqgaMTf2VSHXjIV28CrID.fgN1bGd73VTwLqvmTqHNak79nrRNz7W','server','client,password,refresh_token',NULL,NULL,NULL,NULL,NULL,'true');
...
-- Dump completed on 2020-03-20 23:22:16

CREATE DATABASE IF NOT EXISTS uc DEFAULT CHARACTER SET = utf8mb4;
-- MySQL dump 10.13  Distrib 8.0.17, for osx10.14 (x86_64)
--
...
CREATE DATABASE IF NOT EXISTS gateway DEFAULT CHARACTER SET = utf8mb4;
